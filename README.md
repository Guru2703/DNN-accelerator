...
The accelerator was synthesized and implemented using Xilinx Vivado.
...
| Metric | Result |
|--------|-------:|
| Worst Negative Slack (WNS) | +0.553 ns |
| Total Negative Slack (TNS) | 0 ns |
| Failing Endpoints | 0 |
| Timing Constraints | Met |

The post-implementation design achieved positive setup slack with no failing timing endpoints.

### Synthesis vs. Implementation

| Resource | Synthesis | Post-Implementation |
|----------|----------:|--------------------:|
| LUT      | 8,408 | 7,330 |
| FF       | 2,462 | 2,462 |
| BRAM     | 31.5 | 31.5 |
